...
class CountryGame extends Component {
  ...
  componentDidMount() {
    fetch("https://restcountries.eu/rest/v2/all")
      ...
      .then(countries => {
        ...
        //getOptions function gives 3 country names + current 
  ...
  render() {
    ...
    if (correctOption !== undefined) {
      //get name and flag of correct Country
      const {flag, name} = countries[correctOption];
      //array of ids to object of ids and names
